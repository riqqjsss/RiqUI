function ClosureEvn()
    ...
    function Library.new(config)
        ...
        if config.IsRich then
            Title.RichText = true;
            Title.Text = config.RichText;
        else
            Title.Text = config.Title;
        end;
        ...
        BlockFrame1.BackgroundColor3 = config.BlockFrameColor
        ...
        Twen:Create(BlockFrame1,TweenInfo2,{BackgroundTransparency = config.BlockTransparency2}):Play();
        ...
        BlockFrame3.BackgroundColor3 = config.BlockFrameColor
        ...
        Twen:Create(BlockFrame3,TweenInfo2,{BackgroundTransparency = config.BlockTransparency2}):Play();
        ...
        BlockFrame2.BackgroundColor3 = config.BlockFrameColor
        ...
        Twen:Create(BlockFrame2,TweenInfo2,{BackgroundTransparency = config.BlockTransparency2}):Play();
        ...
        task.spawn(function()
            ...
            UIGradient.Transparency = config.BlockTransparency
        ...
        function WindowTable:NewTab(cfg)
            ...
            function TabTable:NewSection(c_o_n_f_i_g)
                ...
                BlockFrame.ZIndex = 3
                Twen:Create(BlockFrame,TweenInfo2,{BackgroundTransparency = config.BlockTransparency2}):Play();
                ...
                function SectionTable:NewButton(cfg)
                    ...
                    local uiStrokeClonRefer = nil;
                    if cfg.ShowBorder then
                        uiStrokeClonRefer = Instance.new("UIStroke");
                        uiStrokeClonRefer.Color = cfg.BorderColor;
                        uiStrokeClonRefer.Thickness = 0;
                        uiStrokeClonRefer.Parent = FunctionButton;
                    end;
                    ...
                    Button.MouseEnter:Connect(function()
                        ...
                        if cfg.ShowBorder then
                            Twen:Create(uiStrokeClonRefer,TweenInfo.new(0.2),{
                                Thickness = 2
                            }):Play();
                        end;
                    end)
